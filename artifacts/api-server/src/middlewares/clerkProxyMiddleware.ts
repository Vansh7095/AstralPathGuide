/**
 * Clerk Frontend API proxy for production custom-domain support.
...
export function clerkProxyMiddleware(): RequestHandler {
  // Capture the environment variable once so TypeScript can safely
  // narrow it to a string after the existence check.
  const clerkSecretKey = process.env.CLERK_SECRET_KEY;

  // In development, or when Clerk isn't configured, do nothing.
